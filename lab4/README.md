...
3. [Description of the Scheduling Simulator](#description-of-the-scheduling-simulator)
4. [Task 1: Implement Scheduling Algorithms](#task-1-implement-scheduling-algorithms)
5. [Task 2: Implement Scheduling Metrics for Scheduled Jobs](#task-2-implement-scheduling-metrics-for-scheduled-jobs)
6. [Expected Output for Task 1 Schedulers](#expected-output-for-task-1-schedulers)
